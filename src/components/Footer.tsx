         ...
         <div className="container mx-auto px-4">
           ...
           <div className="flex justify-center gap-12">
             ...
             <div className="text-center">
               <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                 <div className="w-48 h-48 mx-auto bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center">
                   <img 
                     ...
                     onError={(e) => {
                       ...
                       if (parent) {
                         parent.innerHTML = '<div class="w-44 h-44 bg-gray-200 dark:bg-gray-700 rounded-xl flex items-center justify-center text-gray-500 text-sm">Vimali QR</div>';
                       }
                     }}
                   />
                 </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                  <div className="w-48 h-48 mx-auto bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center">
                        ...
                        onError={(e) => {
                          ...
                          const parent = target.parentElement;
                          if (parent) {
                            parent.innerHTML = '<div class="w-44 h-44 bg-gray-200 dark:bg-gray-700 rounded-xl flex items-center justify-center text-gray-500 text-sm">QR Code</div>';
                          }
                        }}
                      />
                  </div>
