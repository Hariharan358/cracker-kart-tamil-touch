...
const Index = () => {
  ...
  const res = await fetch("https://api.kmpyrotech.com/api/products/category/ATOM%20BOMB");
  ...
  useEffect(() => {
    const fetchSparklers = async () => {
      try {
  const res = await fetch("https://api.kmpyrotech.com/api/products/category/SPARKLER%20ITEMS");
        const data = await res.json();
