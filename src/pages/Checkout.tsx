        ...
        <div className="w-full px-4 py-16 text-center">
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <p className="text-gray-600 mb-8">Add some amazing crackers to your cart and get ready for a spectacular celebration!</p>
        ...
        <div className="w-full px-4 py-16 text-center">
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <h2 className="text-2xl font-bold mb-4 text-gray-800">Thank you for your order!</h2>
              <p className="text-gray-600 mb-4">We'll process your order and contact you soon.</p>
              {orderId && (
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
      ...
      <div className="w-full px-4 py-8">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">Fill in your details and get ready for an amazing celebration!</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="border-2 border-gray-200 focus:border-orange-500 focus:ring-orange-200 transition-colors"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="border-2 border-gray-200 focus:border-orange-500 focus:ring-orange-200 transition-colors min-h-[80px]"
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="text-center p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl">
                  <p className="text-sm font-semibold text-gray-700 mb-3">UPI Payment</p>
                  <div 
                  ...
                  >
                    <img
                      src="/qrcode1.jpg"
                      alt="UPI Payment QR"
                      className="w-48 h-48 mx-auto rounded-xl border-2 border-blue-200 object-contain shadow-lg"
                    />
                  </div>
                  <p className="text-xs text-gray-600 mt-2">Click to enlarge</p>
                </div>
                
                {/* Second QR Code */}
                <div className="text-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                  <p className="text-sm font-semibold text-gray-700 mb-3">Alternative Payment</p>
                  <div 
                    className="cursor-pointer transform transition-transform hover:scale-105"
                  ...
                  >
                    <img
                      ...
                      className="w-48 h-48 mx-auto rounded-xl border-2 border-green-200 object-contain shadow-lg"
                    />
                  </div>
                  <p className="text-xs text-gray-600 mt-2">Click to enlarge</p>
                </div>
              ...
              <div className="mt-6 text-center">
                <Button asChild variant="outline" className="w-full border-2 border-orange-200 text-orange-600 hover:bg-orange-50">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 relative">
            ...
            <div className="text-center">
              <h3 className="text-xl font-bold text-gray-800 mb-4">{selectedQR.title}</h3>
