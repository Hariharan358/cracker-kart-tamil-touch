              ...
              <CardContent className="max-h-[70vh] overflow-y-auto">
                <div className="mb-4">
                  ...
                  >
                    ...
                    {!categories.find(cat => cat.name === 'KANNAN 5 PIECE GIFT BOX') && (
                      <option value="KANNAN 5 PIECE GIFT BOX">KANNAN 5 PIECE GIFT BOX (0 products)</option>
                    )}
                  </select>
                </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          {!categories.find(cat => cat.name === 'KANNAN 5 PIECE GIFT BOX') && (
                            <SelectItem value="KANNAN 5 PIECE GIFT BOX">KANNAN 5 PIECE GIFT BOX (0 products)</SelectItem>
                          )}
                        </SelectContent>
                      </Select>
                    </div>
